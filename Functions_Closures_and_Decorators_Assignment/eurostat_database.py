def get_description_data():
    # function to return description data from eurostat database
    description = ('Country', [
...
def get_raw_data():
    # function to return raw data from eurostat database, ': ' means that we don’t have data for that year
    raw_data = [
        ('AL', [':', ':', ':', ':', ':', ':', ':', '84', ':']),
